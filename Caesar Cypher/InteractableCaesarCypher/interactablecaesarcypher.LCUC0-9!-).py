...
# This version comes with the lowercase and uppercase alphabet, 0-9, !-) and space characers placed by default within the decypher "charset" box.

from string import ascii_lowercase as lc, ascii_uppercase as uc
numbers = "0123456789"
special = "!@#$%^&*()"
default_txt = lc + uc + numbers + special + " "
...
title2 = tk.Label(master = frame1, text = "Caeser Decypherer", font = ("impact", "20", "bold"), bg = default_bg)
