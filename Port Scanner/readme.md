This is a simple Python 3 based port scanning utility, allowing you to choose to scan every port, commonly exposed port, or a target port. Only works with IPv4 address, no IPv6 support.
